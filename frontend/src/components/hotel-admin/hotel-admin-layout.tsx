...
interface AdminHotelLayoutProps {
  children: React.ReactNode;
  activeSection: 'overview' | 'hotels' | 'my hotels' | 'reservations';
  onSectionChange: (section: 'overview' | 'hotels' | 'my hotels' | 'reservations') => void;
  user: any;
}
